...
const CAT_COLORS = {
  ...
  Restaurants: "bg-orange-500 text-white",

  "Men's Fashion": "bg-blue-600 text-white",

  "Women's Fashion": "bg-pink-500 text-white",

  Electronics: "bg-indigo-600 text-white",

  "Home & Living": "bg-yellow-500 text-black",

  Beauty: "bg-rose-500 text-white",

  Sports: "bg-lime-600 text-white",

  "Kids & Toys": "bg-purple-600 text-white",
  ...
  <div className="mx-auto max-w-7xl px-3 py-4 sm:px-4">
    ...
    <section className="grid gap-3 lg:grid-cols-[1fr_320px]">
      ...
      <div className="relative overflow-hidden rounded-2xl shadow-lg min-h-[280px] sm:min-h-[360px]">
        ...
        <div className="relative z-10 flex h-full max-w-xl flex-col justify-center p-6 text-white sm:p-10">
          <span className="inline-block w-fit rounded-full bg-white/20 px-3 py-1 text-xs font-semibold backdrop-blur">
            🌿 FRESH MEGA SALE
          </span>

          <h1 className="mt-3 text-3xl font-extrabold leading-tight drop-shadow sm:text-5xl">
            Up to 70% off
            <br />
          ...
          <p className="mt-2 max-w-md text-sm opacity-95 sm:text-base">
            From kitchen essentials to fashion finds — fresh, friendly prices.
          </p>

          <Link
            to="/products"
            search={{ cat: "all", q: "" } as any}
            className="mt-5 inline-flex w-fit items-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-bold text-primary shadow hover:scale-[1.02] transition"
          >
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-1">
        ...
        <div className="flex items-center gap-3 rounded-xl border border-border bg-card p-4">
          <div className="grid h-10 w-10 place-items-center rounded-lg bg-amber-500 text-purple-900">
            <FaBolt className="" />
          </div>
          ...
          >
            <div
              className={`
                ...
                rounded-full text-xl font-serif
                ${CAT_COLORS[c.name]}
              `}
            >
    ...
    <section className="mt-8 rounded-2xl border border-warm/30 bg-gradient-to-br from-warm/10 to-primary/5 p-4 sm:p-5">
      <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
        <h2 className="flex items-center gap-2 text-lg font-bold text-warm">
    ...
    <section className="mt-8">
      <div className="mb-3 flex items-center justify-between">
        <h2 className="flex items-center gap-2 text-lg font-bold">
          <SiFoodpanda className="text-primary text-xl" />

          <span>
            Hot from Restaurants
          </span>
        </h2>

        <Link
          to="/products"
          search={{ cat: "Restaurants", q: "" } as any}
          className="text-sm font-semibold text-primary hover:underline"
        >
          View all →
        </Link>
    ...
    <section className="mt-10 grid gap-3 sm:grid-cols-2">
      ...
      <div className="rounded-xl gradient-warm p-6 text-warm-foreground">
        ...
        <p className="mt-1 text-sm opacity-90">
          Across all major cities in Bangladesh
        </p>
      </div>
